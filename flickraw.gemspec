...
Gem::Specification.new do |s|
  ...
  s.date = %q{2009-01-21}
  s.description = %q{Flickr library with a syntax close to the syntax described on http://www.flickr.com/services/api}
  s.email = %q{jake@wideopenspac.es}
  s.files = ["VERSION.yml", "lib/flickraw.rb", "test/test.rb"]
  s.has_rdoc = true
  s.homepage = %q{http://github.com/wideopenspaces/flickraw}
